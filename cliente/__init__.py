...
def cadastrar_cliente(clientes):
    ...
    print('\33[1;34mCliente cadastrado com sucesso!\33[m')
...
def login_cliente(clientes, login, senha):
    ...
    for cliente in clientes:
        if cliente['login'] == login and cliente['senha'] == senha:
            ...
            print(f'\33[1;32mLogin realizado com sucesso. Bem vindo\33[m \33[1;34m{login}!\33[m')
            break
    ...
    while menuCompras:
        ...
        while menuContinuarComprando:
            ...
            if opcao == '1':
                        ...
                        for item in carrinho:
                            for produtoEstoque in produtos:
                                if item['codigo'] == produtoEstoque['codigo']:
                                    print(f"\033[0;36mVocê optou por não comprar: {item['quantidade']} unidades do produto: {item['descricao']}\033[m")
                ...
                print("\33[1;31[mOpção inválida. Por favor, escolha uma opção válida.\33[m")
        break
...
def listar_compras(clienteLogado):
    ...
    if len(clienteLogado['comprados']) > 0:
        ...
        print(f'\033[1;31mNenhum registro encontrado.\033[m')
